...
process ANGSD_THETA_ESTIMATE {
    ...
    angsd -i ${bam} -doSaf 1 -anc ${fasta} -GL 1 -P 4$task.cpus -out out #output is log scale
    ...
    # Python script for genome-wide per-site Watterson’s theta from ANGSD output.
