...
process PAIRWISE_RESAMPLE{
    ...
    pairwise_resample_v2.py pairwise_table.csv ${params.seed} 150
    """
}
...
process LOOKUP_TABLE_LDPOP {
    ...
    """
    #ldtable.py --cores 8 -n ${sample_size} -th ${params.mutation_rate} -rh ${params.ldpop_rho_range} --approx > lookupTable.txt
    ldtable.py --cores 8 -n 150 -th ${params.mutation_rate} -rh ${params.ldpop_rho_range} --approx > lookupTable.txt
    """
}
