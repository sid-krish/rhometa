...
def collect_results_sweep_1(rho, theta, sample_size, depth, genome_size, seed, tract):
    ...
    theta_est_results_dir = f"/home/sid/Github/rhometa/sim_sweep/theta_estimate/"

    col_names = ["rho_sim", "theta_sim", "sample_size_sim", "depth_sim", "genome_size_sim", "seed_sim",
                 "pileup_mean_depth","pileup_median_depth","theta_per_site_mean_depth","theta_per_site_median_depth","genome_length"]
...
if __name__ == '__main__':
    ...
    reorder_cols = ["rho_sim", "theta_sim", "scaled_theta_sim", "sample_size_sim", "depth_sim", "genome_size_sim","seed_sim",
                    "theta_per_site_mean_depth","theta_per_site_median_depth"]
    ...
    ax = sns.catplot(data=collected_results_sweep_1_df, x="scaled_theta_sim", y="theta_per_site_mean_depth", hue="genomes",
                     col="fold_coverage", col_wrap=2, sharex=True, sharey=True, palette="Blues", kind="box",linewidth=0.2)

    ax.set(xlabel="Simulated \u03B8", ylabel="Estimated \u03B8 (mean depth)")
    ...
    collected_results_sweep_1_df["deviation"] = (collected_results_sweep_1_df["theta_per_site_mean_depth"] -
