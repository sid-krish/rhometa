...
if __name__ == '__main__':
    ...
    ax = sns.catplot(data=collected_results_sweep_1_df, x="theta_sim", y='theta_per_site_at_median_depth', hue="genomes",
    ...
    collected_results_sweep_1_df["deviation"] = (collected_results_sweep_1_df['theta_per_site_at_median_depth'] -
                                                 collected_results_sweep_1_df["theta_sim"]) / collected_results_sweep_1_df[
                                                    "theta_sim"]
    
    ax2 = sns.catplot(data=collected_results_sweep_1_df, x="theta_sim", y="deviation", hue="genomes",
